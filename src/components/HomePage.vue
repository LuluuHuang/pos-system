...
<template>
    <div class="row">
        <div class="col-md-3 col-12 d-flex">
            <div class="col-2 m-2 col-form-label">品項</div>
            <div class="col-10">
                <input type="text" v-model="store.searchItem" class="form-control m-2" placeholder="輸入品項">
            </div>
        </div>
        <div class="col-md-3 col-12">
            <button @click="store.search" class="btn btn-primary m-2">查詢</button>
            <button @click="store.clean" class="btn btn-primary m-2">清除</button>
        </div>
        <div class="col-md-3 col-12" v-if="store.currentProduct">
            <ul>
                <li>{{store.currentProduct.name}}</li>
            </ul>
